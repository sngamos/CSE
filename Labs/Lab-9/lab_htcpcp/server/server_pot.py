        ...
        while processing_request:
            ...
            if processing_request:
                ...
                if processing_request and method in ACCEPTED_METHODS:
                    ...
                    headers_to_send = ["HTCPCP/1.1 200 OK\r\n","Server: CoffeePot\r\n","Content-Type: message/coffee-pot\r\n",f"Date: {current_date}\r\n","\r\n"]
                    ...
                    error_response = b"HTCPCP/1.1 406 Not Acceptable\r\n\r\n"
                    send_error_message(connection, error_response)
...
def ensure_request_is_valid(url, content_type, method, connection, requested_pot,
    ...
    if urlToken[1] != "ducky":
        ...
        return False
    if urlToken[0] not in accepted_coffee_schemes:
        send_error_message(connection, not_found_message)
        return False
    return True
